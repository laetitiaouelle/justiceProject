...
<div class="tree">
	<ul> <!-- niv0 -->
		<li>
		<img style="border-radius:50%; width:50px;" src="<?php if(!empty($resltb['avatar'])){ echo 'images/'.$resltb['id'].'_'.$resltb['avatar']; }else{ echo 'images/avatar.png'; } ?>">
		<br>	<a href="#">Moi :<?= $_SESSION['Cnom'].' '.$_SESSION['Cprenom'] ?></a>
