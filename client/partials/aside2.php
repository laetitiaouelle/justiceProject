<?php
                       $usera=$bdd->prepare('SELECT * FROM membres WHERE id=:id and code=:code');
                       $usera->execute([
                           'id'=>$_SESSION['Cid'],
                           'code'=>$_SESSION['Ccode']
                       ]);
                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    <div class="account2">
                        <div class="image img-cir img-120">
                            <img src="<?php if(!empty($reslta['avatar'])){echo 'images/'.$_SESSION['Cid'].'_'.$reslta['avatar'];}else{ echo'images/avatar.png'; }  ?>" alt="<?= $_SESSION['Cnom'].' '. $_SESSION['Cprenom'] ?>" />
                        </div>
                        <h4 class="name"><?= $_SESSION['Cnom'].' '. $_SESSION['Cprenom'] ?></h4>
                    <a href="logout.php">Déconnexion</a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       &"ééééééééééééééééééééééééééééééé'("
